    ...
    <div className="flex-1 overflow-y-auto p-gutter md:p-md lg:p-lg">
      <div className="max-w-7xl mx-auto space-y-md lg:space-y-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-md">
          {/* Stat Card 1 */}
          <div className="bg-surface-container-lowest rounded-xl p-md shadow-ambient hover:shadow-[0_6px_24px_rgba(0,53,39,0.08)] transition-all duration-300 border border-slate-200/50 flex flex-col justify-between">
          ...
          {/* Stat Card 3 */}
          <div className="bg-surface-container-lowest rounded-xl p-md shadow-ambient hover:shadow-[0_6px_24px_rgba(0,53,39,0.08)] transition-all duration-300 border border-slate-200/50 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="xl:col-span-1">
            <div className="bg-surface-container-lowest rounded-xl shadow-ambient border border-slate-200/50 flex flex-col h-full">
              ...
              <div className="flex-1 p-md space-y-md overflow-y-auto">
                ...
                <div className="group flex gap-sm items-start p-sm rounded-lg hover:bg-surface-container-low transition-colors border border-transparent hover:border-surface-variant">
                  <div className="w-12 h-12 rounded-full bg-surface-variant overflow-hidden shrink-0">
                    <img alt="Scholar Portrait" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBpOTHYG5NFR_dA1DUYz4POiIE4aPJw0SRG8jQzJpseH_o_gMbysHtEvgtQcj0HK607XltSZ2iCnQLfF9zUjabvxp69ViE45N8Kl90mrJAnz6-rXNMg33huq4CingKe2ZNF00AhwsMGVb-k_4MiBneQeQxftXFVwt2uDWLg1oZEBcaX7QmQ5A6QAkZlFY1NCXcnLbMmseAzEQxTU8e6UOAMhOFrou30fwazj0yHIoBYvWyc1YzROP6SNriHecXmwKHPt4fy0lcugos" />
                  </div>
                  <div className="flex-1 min-w-0">
              ...
              <div className="p-sm border-t border-surface-variant text-center pb-8">
