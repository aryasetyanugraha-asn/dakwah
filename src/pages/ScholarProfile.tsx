    ...
    <div className="bg-background text-on-background min-h-screen flex flex-col md:flex-row">
      ...
      <header className="lg:hidden bg-white/90 dark:bg-emerald-950/90 backdrop-blur-md docked full-width top-0 sticky z-50 border-b border-emerald-100 dark:border-emerald-900 shadow-sm flex justify-between items-center w-full px-8 py-4">
        ...
        <div className="flex gap-4">
          <span className="material-symbols-outlined text-emerald-900 dark:text-emerald-50 cursor-pointer active:opacity-70 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors duration-200">search</span>
          <span className="material-symbols-outlined text-emerald-900 dark:text-emerald-50 cursor-pointer active:opacity-70 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors duration-200">notifications</span>
          <img alt="Scholar profile avatar" className="w-8 h-8 rounded-full border border-outline-variant cursor-pointer active:opacity-70" data-alt="Small circular avatar profile placeholder" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAgn5mdfn1lr5daScihgQTXwzH6lzBAWiTn0_NSoDO5Fq5JzwyJfKCuMc-tofdkEdtgUTj6Jr3YtuUfpLN2O_bIwGPdv17719SmWIQKVKCWR7lTaRVFTPQ84jJrw5hLx7CJPYBq40gV2u2MDwoO0dX0PWhvElmDkqDUuQrppoVFvA59J7rUd-XU3n6Pk3N7rrs1q-QurKPoXJE-UCLvVwU405ThX0jeQ_Cpfact5X5VgMVP7RlXk4RUmlBaptwzPhOSOzVeHqxFDcY" />
        </div>
      </header>
      {/* Main Content Area */}
      <main className="flex-1 lg:ml-64 w-full flex flex-col min-h-screen">
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-xl items-start relative z-10">
            ...
            <div className="flex-shrink-0 relative group">
              <div className="w-32 h-32 md:w-48 md:h-48 rounded-full border-4 border-surface-container-lowest shadow-lg overflow-hidden relative">
                <img alt="Profile Picture" className="w-full h-full object-cover" data-alt="Portrait of a dignified older scholar with a trimmed beard, wearing traditional modest clothing, soft natural lighting, authoritative yet serene expression" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAjxVHoqEmGZGeFY3ZUi7SHdZ-96G3Qk2zfQKpUtX39HN33gatyzck-Dok8r6xzrQXk3OblO7PtNiADnFn9cTreWdyBvhi4TcqGu7eZSWC0X3pJR0z2-7BBLAG2eHy0fx7j_0uf2plutpf5umdSDs4kjYDl-1ZKKckuU5haO7Henbiu8Rfh0uQBdXjgcVtmQDGF3Kvxm1jW6iMy_KJ_hvk6oG72bCwZd7stAolbMRTPYfUgqGsLXhTpXLC3GomJl5y5N4xngs7t-qM" />
              </div>
        ...
        <div className="flex-1 w-full max-w-7xl mx-auto px-8 lg:px-margin-desktop py-xl grid grid-cols-1 lg:grid-cols-12 gap-xl">
          ...
          <div className="col-span-1 lg:col-span-8 space-y-xl">
            <div className="flex items-center justify-between border-b border-outline-variant/30 pb-4 mb-lg">
              ...
              <a className="font-label-md text-label-md text-primary hover:text-primary-container flex items-center gap-1" href="#">View Full Archive <span className="material-symbols-outlined text-[16px]">arrow_forward</span></a>
            </div>
            {/* Bento Grid for Works */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
              {/* Featured Book Card */}
              <Link to="/content" className="col-span-1 md:col-span-2 bg-surface-container-lowest rounded-xl ambient-shadow border border-outline-variant/20 p-6 flex flex-col md:flex-row gap-6 hover:shadow-md transition-shadow cursor-pointer relative overflow-hidden group block text-left">
                ...
                <div className="w-full md:w-48 h-64 flex-shrink-0 bg-surface-container rounded-lg overflow-hidden border border-outline-variant/30 relative">
                  <img alt="Book Cover" className="w-full h-full object-cover" data-alt="A vintage leather-bound book with intricate gold embossing on the cover, resting on a dark wooden table, dramatic lighting highlighting the texture" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCSc2rL3HxzILi6aiDnVkJtoFx001gxLK6Upr1SeNRsrHYjVIj9sw8C4-lMJnCKncSRMa8KTt4yA6dhl-X9Z1GiwiSheIy8tGrACkAHkvrai_kNmBKT5N6mIFOBZ-1RqUx5h2prxOI5noO50xBtgdDUk7i3BQNQD8T4Eq6oYtPdwDY4AmXj6wBe76iEscm6rb-zfic46W4k4QglPdmLg4ziKD0A-ODhAHFndkiz7oOgeIKQZPYWmzyLJ5QBfKZ8IJDyOm52uHxySw0" />
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <div className="mt-auto flex items-center gap-4">
                    <button className="font-label-md text-label-md text-primary flex items-center gap-1 hover:underline"><span className="material-symbols-outlined text-[18px]">menu_book</span> Read Excerpt</button>
                    <span className="text-outline-variant">•</span>
                    <span className="font-label-md text-label-md text-on-surface-variant flex items-center gap-1"><span className="material-symbols-outlined text-[16px]">visibility</span> 4.2k Reads</span>
                  </div>
                </div>
              </Link>
              {/* Article Card 1 */}
              <Link to="/content" className="bg-surface-container-lowest rounded-xl ambient-shadow border border-outline-variant/20 p-6 flex flex-col hover:shadow-md transition-shadow cursor-pointer group block text-left">
              ...
              {/* Article Card 2 */}
              <div className="bg-surface-container-lowest rounded-xl ambient-shadow border border-outline-variant/20 p-6 flex flex-col hover:shadow-md transition-shadow cursor-pointer group block text-left">
                <div className="flex items-center gap-2 mb-4">
        ...
        <footer className="mt-auto bg-slate-50 dark:bg-emerald-950/50 border-t border-slate-200 dark:border-emerald-900 full-width py-12 flat no shadows">
          <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-6">
            <span className="font-sans text-xs uppercase tracking-widest text-slate-600 dark:text-slate-400">© 2024 Al-Maktabah. Preserving the Sacred Tradition.</span>
            <div className="flex gap-6">
              <a className="font-sans text-xs uppercase tracking-widest text-slate-500 dark:text-slate-500 hover:text-emerald-800 dark:hover:text-emerald-200 underline decoration-emerald-200 transition-all opacity-100 hover:opacity-80" href="#">Archives</a>
              <a className="font-sans text-xs uppercase tracking-widest text-slate-500 dark:text-slate-500 hover:text-emerald-800 dark:hover:text-emerald-200 underline decoration-emerald-200 transition-all opacity-100 hover:opacity-80" href="#">Scholarly Ethics</a>
              <a className="font-sans text-xs uppercase tracking-widest text-slate-500 dark:text-slate-500 hover:text-emerald-800 dark:hover:text-emerald-200 underline decoration-emerald-200 transition-all opacity-100 hover:opacity-80" href="#">Open Access</a>
              <a className="font-sans text-xs uppercase tracking-widest text-slate-500 dark:text-slate-500 hover:text-emerald-800 dark:hover:text-emerald-200 underline decoration-emerald-200 transition-all opacity-100 hover:opacity-80" href="#">Contact</a>
            </div>
          </div>
        </footer>
      </main>
